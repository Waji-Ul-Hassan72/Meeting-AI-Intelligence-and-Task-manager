    ...
    <div className="min-h-screen bg-[#f7f9fb] text-slate-900 font-sans">
      ...
      <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-5 lg:px-8 sticky top-0 z-40">
        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          <button
            className="px-4 py-2 rounded-lg bg-teal-50 text-teal-700 text-xs font-bold"
          >
            Dashboard
          </button>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Manage your projects, teams and
        ...
        <section>
          ...
          {projects.length === 0 ? (
            ...
            <div className="bg-white border border-dashed border-slate-300 rounded-2xl p-12 text-center">
              ...
              <div className="w-12 h-12 mx-auto rounded-xl bg-teal-50 text-teal-600 flex items-center justify-center text-xl mb-4">
                +
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
              ...
              {projects.map((project) => (
                ...
                <div
                  key={project.id}
                  className="bg-white border border-slate-200 rounded-2xl p-5 hover:border-teal-300 hover:shadow-lg hover:shadow-slate-200/50 transition-all"
                >
                  ...
                  >
                    ...
                    <h4 className="text-sm font-extrabold text-slate-900 hover:text-teal-700 transition">
                      {project.name ||
                        project.title ||
                        "Unnamed Project"}
                    </h4>

                    <p className="text-xs text-slate-500 mt-2 leading-5 line-clamp-2 min-h-[40px]">
                      {project.description ||
                  ...
                  <div className="flex items-center gap-2 mt-5 pt-4 border-t border-slate-100">
                    ...
                    <button
                      ...
                      className="px-3 py-2 rounded-lg bg-teal-50 text-teal-700 text-[10px] font-bold hover:bg-teal-100 transition disabled:opacity-50"
                    >
                      Edit
                    </button>
                    ...
                    <button
                      ...
                      className="px-3 py-2 rounded-lg bg-red-50 text-red-600 text-[10px] font-bold hover:bg-red-100 transition disabled:opacity-50"
                    >
                      {deletingProjectId ===
                      project.id
                        ? "..."
            ...
            >
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button
                  type="submit"
                  disabled={updatingProject}
                  className="flex-1 py-3 rounded-xl bg-teal-600 text-white text-xs font-bold hover:bg-teal-700 disabled:opacity-50"
                >
                  {updatingProject
                    ? "Saving..."
                    : "Save Changes"}
